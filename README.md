# bRAC сделан не мной
Автор bRAC - Миксрей/MeexReay/MixRay удалил весь созданный собой контент из интернета

Я попытаюсь поддерживать этот форк, стараясь не делать сильных изменений

[Последний коммит миксрея](https://github.com/Forbirdden/bRAC/commit/fa75ca60c4991ded6449fb0cbb1c19ed32597782)
